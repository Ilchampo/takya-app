      ...
      >
        ...
        <View style={styles.heading}>
          ...
          <Text style={[styles.intro, { color: theme.colors.textMuted }]}>
            Takya acerca información pública sin convertirla en un juicio sobre
        ...
        >
          ...
          <Text style={[styles.body, { color: theme.colors.textMuted }]}>
            No necesitas crear una cuenta. La placa se consulta directamente
            desde tu teléfono a las fuentes públicas y Takya no usa un servidor
            propio para recolectar, vender o analizar tus búsquedas.
          </Text>
          <View style={[styles.fact, { borderTopColor: theme.colors.border }]}>
            ...
            <Text style={[styles.factText, { color: theme.colors.text }]}>
              El historial local guarda hasta 5 consultas y elimina cada
              registro después de 3 días.
            </Text>
          </View>
        </View>
        ...
        >
          ...
          <Text style={[styles.noticeText, { color: theme.colors.text }]}>
            La presencia o ausencia de registros no prueba culpabilidad,
            inocencia, ni que un vehículo sea seguro o inseguro. Contrasta
            siempre la información con las autoridades y con el vehículo que
            observas.
          </Text>
        </View>
