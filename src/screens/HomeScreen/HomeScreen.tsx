...
import {
  ...
  isValidPlate,
  normalizePlate,
} from "../../lib/utils/licensePlate.utils";
...
export const HomeScreen: React.FC<HomeScreenProps> = (props) => {
  ...
  const searchingThisPlate =
    valid && loading && result?.plate === normalizePlate(plate);
      ...
      >
        ...
        >
          ...
          <View style={styles.main}>
                  ...
                  {history.map((item, index) => (
                    ...
                    >
                      ...
                      <View style={styles.historyCopy}>
                        ...
                        >
                          {describeLookupAge(item.fetchedAt)} · Ver resumen
                        </Text>
                      </View>
                      <Icon
                        name="chevron"
            ...
            {!storageAvailable && (
              <Text
                style={[styles.smallText, { color: theme.colors.textMuted }]}
              >
